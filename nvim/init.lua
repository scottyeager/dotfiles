...
-- My awesome keybinds
-- I don't know if noremap is useful here I don't think we'll be mapping anything onto C-c to get recursively mapped here, but who knows?
vim.keymap.set('v', '<C-c>', '"+y', { noremap = true })
vim.keymap.set('n', '<C-c>', 'V"+y', { noremap = true })
...
require('lazy').setup({
            ...
            pylsp = {
              plugins = {
                pycodestyle = {
                  enabled = false,
                  ignore = {
                    'W391', -- New lines at end of file
                    'E305', -- Two empty lines after class
                    'E302', -- Two empty lines between imports and def(?)
                    'E501', -- Max line length (isn't fixed by setting maxLineLength)
                  },
                  maxLineLength = 100,
                },
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ...
      highlight = {
        enable = true,
        disable = { 'dockerfile' }, -- Until this gets fixed: https://github.com/camdencheek/tree-sitter-dockerfile/issues/51
